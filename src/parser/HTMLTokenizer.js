...
function parseHTML (html, options) {
  ...
  const canBeLeftOpenTag = options.canBeLeftOpenTag
  let index = 0
  let last, lastTag
  while (html) {
    last = html
    ...
    if (!lastTag || !isPlainTextElement(lastTag)) {
      ...
      if (textEnd === 0) {
        ...
        if (isConditionalComment.test(html)) {
      ...
      if (textEnd >= 0) {
        ...
        while (
          ...
          !isComment.test(rest) &&
          !isConditionalComment.test(rest)
          ) {
